...
declare class Ok<A$1, E$1 = never> {
   ...
   */
  mapError<E2, R extends AnyResult = this>(this: R, _fn: (e: InferErr<R>) => E2): MapErrorReturn<R, E2>;
  /**
   * No-op on Ok, returns self with new phantom error type.
   *
   * @template E2 New error type.
   ...
   */
  tryRecover<E2, R extends AnyResult = this>(this: R, _fn: (e: InferErr<R>) => Result$1<NoInfer$2<InferSuccess<R>>, E2>): TryRecoverReturn<R, E2>;
  /**
   ...
   */
  tryRecoverAsync<E2, R extends AnyResult = this>(this: R, _fn: (e: InferErr<R>) => Promise<Result$1<NoInfer$2<InferSuccess<R>>, E2>>): Promise<TryRecoverReturn<R, E2>>;
  /**
   ...
   */
  andThen<B, E2, R extends AnyResult = this>(this: R, fn: (a: InferOk<R>) => Result$1<B, E2>): AndThenReturn<R, B, E2>;
  /**
   ...
   */
  andThenAsync<B, E2, R extends AnyResult = this>(this: R, fn: (a: InferOk<R>) => Promise<Result$1<B, E2>>): Promise<AndThenReturn<R, B, E2>>;
  /**
   ...
   */
  match<T$1, R extends AnyResult = this>(this: R, handlers: {
    ok: (a: InferOk<R>) => T$1;
   ...
   * @returns Promise of self.
   */
  tapErrorAsync<R extends AnyResult = this>(this: R, _fn: (e: InferErr<R>) => Promise<void>): Promise<R>;
  /**
   ...
   */
  tapBothAsync<R extends AnyResult = this>(this: R, handlers: TapBothAsyncHandlersFor<R>): Promise<R>;
  /**
...
declare class Err<T$1, E$1> {
   ...
   */
  mapError<E2, R extends AnyResult = this>(this: R, fn: (e: InferErr<R>) => E2): MapErrorReturn<R, E2>;
  /**
   ...
   */
  tryRecover<E2, R extends AnyResult = this>(this: R, fn: (e: InferErr<R>) => Result$1<NoInfer$2<InferSuccess<R>>, E2>): TryRecoverReturn<R, E2>;
  /**
   ...
   */
  tryRecoverAsync<E2, R extends AnyResult = this>(this: R, fn: (e: InferErr<R>) => Promise<Result$1<NoInfer$2<InferSuccess<R>>, E2>>): Promise<TryRecoverReturn<R, E2>>;
  /**
   ...
   * @returns Self.
   */
  andThen<U, E2, R extends AnyResult = this>(this: R, _fn: (a: InferOk<R>) => Result$1<U, E2>): AndThenReturn<R, U, E2>;
  /**
   ...
   * @returns Promise of self.
   */
  andThenAsync<U, E2, R extends AnyResult = this>(this: R, _fn: (a: InferOk<R>) => Promise<Result$1<U, E2>>): Promise<AndThenReturn<R, U, E2>>;
  /**
   * Pattern matches on Result.
   *
   ...
   */
  match<U, R extends AnyResult = this>(this: R, handlers: {
    ok: (a: InferOk<R>) => U;
    err: (e: InferErr<R>) => U;
  }): U;
  /**
   ...
   */
  tapErrorAsync<R extends AnyResult = this>(this: R, fn: (e: InferErr<R>) => Promise<void>): Promise<R>;
  /**
